...
def quickFeaX(rawXi, end_day):
    fea_Xi_closeMean = joinFeas(closeMean(rawXi, end_day, 5), closeMean(rawXi, end_day, 20),
                                closeMean(rawXi, end_day, 50),
                                closeMean(rawXi, end_day, 80), closeMean(rawXi, end_day, 122),
                                closeMean(rawXi, end_day, 244))
